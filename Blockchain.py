...
class Blockchain:
    ...
    #verifies whether new proof of work is valid or not i.e. nounce
...
def is_valid():
    ...
    if is_valid:
        ...
        response = {'message': 'Akku, we have a problem. The Blockchain is not valid.'}
    return jsonify(response), 200
